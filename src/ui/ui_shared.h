...
typedef struct {
	...
	void ( *drawHandlePic )( float x, float y, float w, float h, qhandle_t asset, int mode );
	void ( *drawStretchPic )( float x, float y, float w, float h, float s1, float t1, float s2, float t2, qhandle_t hShader );
	void ( *drawText )( float x, float y, int font, float scale, vec4_t color, const char *text, float adjust, int limit, int style, int mode );
	...
	void ( *fillRect )( float x, float y, float w, float h, const vec4_t color, int mode );
	void ( *drawRect )( float x, float y, float w, float h, float size, const vec4_t color, int mode );
	void ( *drawSides )( float x, float y, float w, float h, float size, int mode );
	void ( *drawTopBottom )( float x, float y, float w, float h, float size, int mode );
	void ( *clearScene )();
