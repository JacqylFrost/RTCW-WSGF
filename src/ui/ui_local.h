...
extern void         UI_DrawHandlePic( float x, float y, float w, float h, qhandle_t hShader, int mode );
extern void         UI_FillRect( float x, float y, float width, float height, const float *color, int mode );
extern void         UI_DrawRect( float x, float y, float width, float height, const float *color, int mode );
...
extern void         UI_ScaleFrom640( float *x, float *y, float *w, float *h, int mode );
